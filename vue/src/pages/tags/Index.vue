		...
		<Row class="mb15">
			<Col :span="16">
				<ButtonGroup>
                    ...
                    <Button type="ghost" icon="plus-round" @click="$router.push('/tags/create')">添加</Button>
			    </ButtonGroup>
			</Col>
			<Col :span="8">
    ...
    export default {
                    ...
                    },
                    {
                        ...
                        render : (h,params) => {
                            return h('icon',{
                                ...
                                on: {
                                        click: () => {
                                            this.$http.post('/admin/tags/status',{id:params.row.id})
                                                .then(res => {
                                                    this.loadData();
                                                })
                                        }
                        ...
                        render: (h, params) => {
                            return h('div', [
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            this.$router.push('/tags/update/' + params.row.id);
                                        }
                                    }
                                }),
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            this.$Modal.confirm({
                                                content: '确定要删除该数据吗？',
                                                onOk: () => {
                                                    this.$http.post('/admin/tags/delete', {id: params.row.id})
                                                        .then(res => {
                                                            this.loadData();
                                                        })
                                                }
        ...
        methods: {
            loadData()
            {
                ...
                this.$http.get('/admin/tags/list', {params: params})
                    .then(res => {
            ...
            toEdit(row)
            {
                this.$router.push('/tags/update/' + row.id);
            }
        }
    }
</script>
